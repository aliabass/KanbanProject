...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return serviceFactory.Register(email, password);
        }
        ...
        {
            return serviceFactory.Login(email, password);
        }
        ...
        {
            return serviceFactory.Logout(email);
        }
        ...
        {
            return serviceFactory.LimitColumn(email, boardName, columnOrdinal, limit); 
        }
        ...
        {
            return serviceFactory.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return serviceFactory.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
           return serviceFactory.AddTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return serviceFactory.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return serviceFactory.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return serviceFactory.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return serviceFactory.AdvanceTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return serviceFactory.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return serviceFactory.AddBoard(email, name);    
        }
        ...
        {
            return serviceFactory.RemoveBoard(email, name);
        }
        ...
        {
            return serviceFactory.InProgressTasks(email);
        }
        ...
        {
            return serviceFactory.GetUserBoards(email);
        }
        ...
        {
            return serviceFactory.GetBoardName(boardId);
        }
        ...
        {
            return serviceFactory.JoinBoard(email, boardID);
        }
        ...
        {
            return serviceFactory.LeaveBoard(email, boardID);
        }
        ...
        {
            return serviceFactory.AssignTask(email, boardName, columnOrdinal, taskID, emailAssignee);
        }
        ...
        {
            return serviceFactory.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
        }
